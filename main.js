var app = (function() {
      ...
      m.$on("click", e[4]), {
        c() {
          ...
          Q(i.$$.fragment),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "indigo girls heardle"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-3">a clone of <a href="https://www.heardle.app/" title="heardle">heardle</a> but for indigo girls songs. each song is randomly chosen from their discography.</p> \n\n<p class="mb-3">made by <a href="https:www.lifeblood.net">www.lifeblood.net</a>. all copyright goes to amy ray, emily saliers, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">soundCloud</a>\n and powered by <a href="https://glitch.com/">glitch</a>. See the source code <a href="https://glitch.com/edit/#!/indigogirls-heardle">here</a>.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  const Vt = {
    ...
    Jt = ["try again tomorrow?", "take a bow!", "impressive!", "bravo!", "awesome!", "gutsy!", "whew!"];
      ...
      (O = new Rt({})), {
        c() {
          ...
          W.c(),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "next indigo girls song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("you got today's indigo girls heardle within the first ")),
        (n = _(s)),
        (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("you got today's indigo girls heardle within ")),
        (n = _(o)),
        (r = _("\n                second")),
        (s = _(a)),
        (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("you didn't get today's indigo girls heardle. better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
    ...
    return (
      ...
      [
        ...
        () => {
          ...
          let e = "indigo girls heardle #" + (s.id + 1),
            t = "";
          a
            ?
          ...
          let o =
            ...
            t +
            "\n\n" +
            "https://indigogirls-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
      ...
      "indigo girls - sugar tongue (live)",
      "indigo girls - virginia woolf (live)",
      "indigo girls - happy in the sorrow key (live)",
      "indigo girls - come a long way (live)"
    ]),
    On = {
      subscribe: ue(
        [{
            url: "https://soundcloud.com/indigo-girls-official/long-ride",
            answer: "indigo girls - long ride",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/shit-kickin",
            answer: "indigo girls - shit kickin'",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/change-my-heart",
            answer: "indigo girls - change my heart",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/sugar-tongue-live-1",
            answer: "indigo girls - sugar tongue (live)",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/virginia-woolf-live",
            answer: "indigo girls - virginia woolf (live)",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/happy-in-the-sorrow-key-live",
            answer: "indigo girls - happy in the sorrow key (live)",
          },
          {
            url: "https://soundcloud.com/indigo-girls-official/come-a-long-way-live",
            answer: "indigo girls - come a long way (live)",
          },
        ],
        Pn
      ).subscribe,
    ...
    return {
      c() {
        ...
        Q(l.$$.fragment),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "indigo girls hearle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "guess the indigo girls song from the intro in as few tries as possible"
          ),
